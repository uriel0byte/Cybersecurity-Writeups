...
* **Step 4: Defense Evasion & Cleanup**
  * *Method:*  Child process analysis indicated the malware executed commands to delete all DLL files within the `C:\ProgramData\` directory in the Any.run sandbox report. This is Anti-Forensics / Indicator Removal on Host `(T1070.004)`.
